...
# ----------------------------------------------------------------
GEMINI_MODEL_IMAGE           = "gemini-2.5-flash-image"                        # Génération image — qualité/coût optimal
GEMINI_MODEL_IMAGE_PRO2      = "gemini-2.5-flash-image"                        # Génération image flash (même modèle)
